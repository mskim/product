...
class CatalogsControllerTest < ActionController::TestCase
  ...
  test "should create catalog" do
    assert_difference('Catalog.count') do
      post :create, catalog: { description: @catalog.description, publication_date: @catalog.publication_date, title: @catalog.title }
    end
  ...
  test "should update catalog" do
    put :update, id: @catalog, catalog: { description: @catalog.description, publication_date: @catalog.publication_date, title: @catalog.title }
    assert_redirected_to catalog_path(assigns(:catalog))
  end
